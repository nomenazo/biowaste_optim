function dydt=compostingHC(t,y);
...
rhoair = 1.2; %kg/m3
Vtotal = 0.5; %m3 %L 720 X l 850 X H 840
...
%Passive aeration air = 0.08 l/mn.kg
%Turning heaps air = 0.08 l/mn.kg
%active aeration air = 0.3 l/mn.kg
...
U = KT(4); %heat transfer coefficient of wood (kJ/m2.K.h) %%valeur dans de Guardia 2012 : 7W/m2.C = 0.09 kJ/m2.h.K
A = KT (5); %surface area of heat conduction (m2) %L 720 X l 850 X H 840
